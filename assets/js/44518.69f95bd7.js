...
`,d=(0,a.SL)(({theme:e,children:t,forwardedRef:o,color:a=c.T,...s})=>r.createElement(n.NP,{theme:e},r.createElement(l,{role:"tablist",ref:o,color:a,...s},t)),s.A)},42302:(e,t,o)=>{"use strict";o.d(t,{A:()=>l});const r={randomUUID:"undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto)};let n;const a=new Uint8Array(16);function s(){if(!n&&(n="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!n))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return n(a)}const c=[];for(let d=0;d<256;++d)c.push((d+256).toString(16).slice(1));function i(e,t=0){return(c[e[t+0]]+c[e[t+1]]+c[e[t+2]]+c[e[t+3]]+"-"+c[e[t+4]]+c[e[t+5]]+"-"+c[e[t+6]]+c[e[t+7]]+"-"+c[e[t+8]]+c[e[t+9]]+"-"+c[e[t+10]]+c[e[t+11]]+c[e[t+12]]+c[e[t+13]]+c[e[t+14]]+c[e[t+15]]).toLowerCase()}const l=function(e,t,o){if(r.randomUUID&&!t&&!e)return r.randomUUID();const n=(e=e||{}).random||(e.rng||s)();if(n[6]=15&n[6]|64,n[8]=63&n[8]|128,t){o=o||0;for(let e=0;e<16;++e)t[o+e]=n[e];return t}return i(n)}},50159:(e,t,o)=>{"use strict";o.d(t,{A:()=>h});var r=o(96540),n=o(48483),a=o(65227),s=o(62695);const c=n.i7`
  from {
...
`,i=n.AH`
  animation: ${c} ${({theme:e})=>e.transitionSpeedSpinner} linear
    infinite;
`,l=n.Ay.svg`
  ${({hasAnimation:e})=>e?i:""}
`,d="small",u="large2x",m=n.Ay.div`
  display: flex;
...
`,b=n.Ay.div`
  ...
  font-stretch: ${({theme:e})=>e.fontStretch};
  font-style: ${({theme:e})=>e.fontStyle};
  font-weight: ${({theme:e})=>e.fontWeight};
  letter-spacing: ${({theme:e})=>e.letterSpacing};
  line-height: ${({theme:e})=>e.lineHeight};
  text-align: center;
  width: 100%;
  color: ${({theme:e})=>e.color};
`,h=(0,a.SL)(({testId:e="SPINNER",text:t="",theme:o,size:c="default",strokeWidth:i,hasAnimation:h=!0,...g})=>{const f=(({theme:e,size:t})=>"number"==typeof t?t:t===d?e.widthSpinnerSmall:t===u?e.widthSpinnerExtraLarge:e.widthSpinnerDefault)({theme:o,size:c}),p=i||f/24,k=Math.max(.1,Math.floor(f/2)),B=Math.max(.1,Math.floor(k/2)),v=Math.max(.1,B-p),w=2*Math.PI*v*.83,x=(0,s.A)(),C=()=>r.createElement(l,{...(0,a.a3)(e),role:"img",...t&&{"aria-labelledby":x},hasAnimation:h,...g,fill:"none",xmlns:"http://www.w3.org/2000/svg",preserveAspectRatio:"xMidYMid",viewBox:`0 0 ${k} ${k}`,height:`${f}px`,width:`${f}px`},r.createElement("circle",{r:v,cx:B,cy:B,fill:"none",stroke:o.withSpinnerBackground?o.backgroundContainer:"none",strokeWidth:p}),r.createElement("circle",{r:v,cx:B,cy:B,fill:"none",stroke:o.backgroundFiller,strokeWidth:p,strokeLinecap:"round",strokeDasharray:w}));return r.createElement(n.NP,{theme:o},t?r.createElement(m,null,C(),t&&r.createElement(b,{id:x},t)):C())},"loaders")},54004:(e,t,o)=>{"use strict";o.d(t,{A:()=>u});var r=o(96540),n=o(48483),a=o(65227),s=o(11599),c=o(82413);const i=n.Ay.button.attrs(({isDisabled:e=!1,isActive:t,type:o="button"})=>({disabled:e,"aria-selected":t,type:o}))`
