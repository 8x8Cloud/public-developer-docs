  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        type: 'category',
        label: 'Viber',
        link: { type: 'doc', id: 'connect/docs/viber/viber-hub' },
        collapsed: true,
        items: [
          'connect/docs/viber/concepts-fundamentals',
          'connect/docs/viber/getting-started',
          'connect/docs/viber/account-onboarding',
          {
            type: 'category',
            label: 'Viber over 8x8 API',
            link: { type: 'doc', id: 'connect/docs/viber/sending-viber-messages-api' },
            collapsed: true,
            items: [
              'connect/docs/viber/message-api-library',
              'connect/docs/viber/template-message-api-library',
              'connect/docs/viber/sessions',
              'connect/docs/viber/webhooks-delivery-receipts',
            ],
          },
