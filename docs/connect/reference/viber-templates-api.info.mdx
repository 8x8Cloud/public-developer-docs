---
id: viber-templates-api
title: "Viber Templates API"
description: "Manage Viber message templates: register, list, and delete pre-approved message formats for sending transactional messages and OTPs via Viber."
