...
import StreamingRegionPicker from '@site/docusaurus/components/StreamingRegionPicker';
...
Your Contact Center cluster is the `vcc-<cluster>.8x8.com` host you see when accessing Configuration Manager. Select it below to get the WebSocket hostname for your region.

<StreamingRegionPicker />

### Available Regions

| 8x8 Region | CC Cluster | Hostname | Availability |
|------------|------------|----------|--------------|
| UK3 | EU4, EU5, EU6, EU7, EU8, EU9, EU10, EU11, EU12, EU13, EU14 | `pulsar-ws-euw2.8x8.com` | Available |
| US1 | NA1, NA2, NA3, NA4, NA5, NA6, NA11, NA12, NA13, NA14, NA15, NA16, SB1 | `pulsar-ws-use1.8x8.com` | Available |
| US2 | NA7, NA8, NA9, NA10, NA17, NA18, NA19, NA20, NA27, NA28, NA29, NA30, NA37, NA38, NA39 | `pulsar-ws-usw2.8x8.com` | Available |
| HK1 | AP1 | N/A | Pending |
| HK2 | AP21 | N/A | Pending |
| LH1 | EU21 | N/A | Pending |
| ON1 | BC1, BC2, BC3 | N/A | Pending |
| PA1 | EU31 | N/A | Pending |
| SK1 | CA1, CA2 | N/A | Pending |
| SY1 | AU1, AU2 | N/A | Pending |
...
>
> **Note:** Regions marked **Pending** are being deployed progressively and have no endpoint yet. This table will be updated as each region becomes available.
